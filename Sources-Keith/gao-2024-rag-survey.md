...
Shanghai Research Institute for Intelligent Autonomous Systems, Tongji University b Shanghai Key Laboratory of Data Science, School of Computer Science, Fudan University c College of Design and Innovation, Tongji University
...
Corresponding Author.Email:haofen.wang@tongji.edu.cn in Figure 1. The development trajectory of RAG in the era of large models exhibits several distinct stage characteristics. Initially, RAG's inception coincided with the rise of the Transformer architecture, focusing on enhancing language models by incorporating additional knowledge through PreTraining Models (PTM). This early stage was characterized by foundational work aimed at refining pre-training techniques [3]-[5].The subsequent arrival of ChatGPT [6] marked a pivotal moment, with LLM demonstrating powerful in context learning (ICL) capabilities. RAG research shifted towards providing better information for LLMs to answer more complex and knowledge-intensive tasks during the inference stage, leading to rapid development in RAG studies. As research progressed, the enhancement of RAG was no longer limited to the inference stage but began to incorporate more with LLM fine-tuning techniques.
...
[2 https://www.llamaindex.ai](https://www.llamaindex.ai/)
...
|                                        |                                          |                                          |                         | Inference            |                          |
| PGRA [33]                              | Wikipedia                                | Text                                     | Sentence                | Inference            | Once Once                |
| FILCO [34] RADA [35]                   | Wikipedia Dataset-base                   | Text Text                                | Sentence Sentence       | Inference            | Once                     |
| [36]                                   |                                          |                                          | Sentence                | Inference            | Once                     |
| Filter-rerank                          | Synthesized dataset                      | Text                                     |                         | Tuning               |                          |
| R-GQA [37]                             | Dataset-base                             | Text                                     | Sentence Pair           |                      | Once                     |
...
| RRR [7]                                | Search Engine                            |                                          | Chunk                   | Tuning               | Once                     |
| RA-e2e [46]                            | Dataset-base                             | Text Text                                | Chunk                   | Tuning               | Once                     |
| PROMPTAGATOR [21]                      | BEIR                                     | Text                                     | Chunk                   | Tuning               | Once                     |
| AAR [47]                               |                                          |                                          |                         | Tuning               | Once                     |
| RA-DIT [27]                            | MSMARCO,Wikipedia Common Crawl,Wikipedia | Text Text                                | Chunk Chunk             | Tuning               | Once                     |
| RAG-Robust [48]                        | Wikipedia                                | Text                                     | Chunk                   | Tuning               | Once                     |
| RA-Long-Form [49]                      | Dataset-base                             |                                          | Chunk                   | Tuning               | Once                     |
| CoN [50]                               | Wikipedia                                | Text Text                                | Chunk                   | Tuning               | Once                     |
...
| IAG [55] NoMIRACL [56]                 | Search Engine,Wikipedia                  | Text                                     | Chunk                   | Inference Inference  | Once                     |
|                                        | Wikipedia                                | Text                                     | Chunk                   |                      | Once                     |
| ToC [57]                               | Search Engine,Wikipedia                  | Text                                     | Chunk                   | Inference Inference  | Recursive                |
| SKR [58]                               | Dataset-base,Wikipedia                   | Text                                     | Chunk                   |                      | Adaptive                 |
| ITRG [59]                              | Wikipedia                                | Text                                     | Chunk                   | Inference            |                          |
|                                        | Dataset-base                             | Text                                     | Chunk                   | Inference            | Iterative Once           |
| RAG-LongContext [60] ITER-RETGEN [14]  | Wikipedia                                | Text                                     | Chunk                   | Inference            | Iterative                |
| IRCoT [61] LLM-Knowledge-Boundary [62] | Wikipedia Wikipedia                      | Text Text                                | Chunk Chunk             | Inference Inference  | Recursive Once           |
| RAPTOR [63]                            |                                          | Text                                     | Chunk                   | Inference            | Recursive                |
| RECITE [22]                            | Dataset-base                             | Text                                     | Chunk                   | Inference            | Once                     |
| ICRALM [64]                            | LLMs Pile,Wikipedia                      | Text                                     | Chunk                   | Inference            | Iterative                |
| Retrieve-and-Sample [65] Zemi [66]     | Dataset-base                             | Text                                     | Doc                     | Tuning               | Once                     |
| CRAG [67]                              | C4                                       | Text                                     | Doc                     | Tuning               | Once                     |
| 1-PAGER                                | Arxiv                                    | Text                                     | Doc                     | Inference            | Once                     |
| [68] PRCA [69]                         | Wikipedia                                | Text                                     | Doc                     | Inference            | Iterative                |
|                                        | Dataset-base Dataset-base                | Text Text                                | Doc Doc                 | Inference Inference  | Once Once                |
| QLM-Doc-ranking [70] Recomp [71]       | Wikipedia                                | Text                                     |                         |                      |                          |
| DSP [23]                               |                                          | Text                                     | Doc                     | Inference            | Once                     |
| RePLUG [72]                            | Wikipedia Pile                           | Text                                     | Doc                     | Inference            | Iterative                |
| ARM-RAG                                |                                          | Text                                     | Doc                     | Inference            | Once                     |
| [73] GenRead [13]                      | LLMs                                     | Text                                     | Doc Doc                 | Inference Inference  |                          |
| UniMS-RAG                              | Dataset-base                             | Text                                     | Multi                   |                      |                          |
| [74]                                   |                                          |                                          |                         | Tuning               | Iterative Iterative Once |
| CREA-ICL [19] PKG [75]                 | Dataset-base Dataset-base LLM            |                                          | Chunk                   | Inference Inference  | Once Once                |
|                                        |                                          | Crosslingual,Text Tabular,Text Code,Text | Sentence Item           |                      | Once                     |
| SANTA [76]                             | Dataset-base                             |                                          |                         | Pre-training         |                          |
| SURGE [77]                             | Freebase                                 | KG                                       |                         | Tuning               | Once                     |
| MK-ToD [78]                            | Dataset-base                             | KG                                       | Entity                  | Tuning               | Once                     |
|                                        | Dataset-base                             | KG                                       | Sub-Graph               | Tuning               | Once                     |
| Dual-Feedback-ToD [79] KnowledGPT [15] | Dataset-base                             | KG                                       | Entity Sequence Triplet | Inference            |                          |
| FABULA [80]                            | Dataset-base,Graph                       |                                          |                         | Inference            | Muti-time Once           |
| HyKGE [81]                             | CMeKG                                    | KG KG                                    | Entity Entity           | Inference            | Once                     |
| KALMV [82]                             | Wikipedia                                | KG                                       | Triplet                 | Inference            |                          |
| RoG [83]                               | Freebase                                 | KG                                       | Triplet                 | Inference            | Iterative                |
| G-Retriever [84]                       |                                          |                                          |                         | Inference            | Once                     |
|                                        |                                          |                                          |                         |                      | Iterative                |
|                                        |                                          | TextGraph                                |                         |                      |                          |
|                                        | Dataset-base                             |                                          |                         |                      |                          |
|                                        |                                          |                                          | Sub-Graph               |                      |                          |
...
[4 https://hotpotqa.github.io/wiki-readme.html](https://hotpotqa.github.io/wiki-readme.html)
...
[6 https://github.com/aurelio-labs/semantic-router](https://github.com/aurelio-labs/semantic-router)

[7 https://huggingface.co/spaces/mteb/leaderboard](https://huggingface.co/spaces/mteb/leaderboard)
...
|-----------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| QA        | Single-hop                                                                                                                                                             | Natural Qustion(NQ) [111] TriviaQA(TQA) [113] SQuAD [114] Web Questions(WebQ) [115]                                                                                                        | [26], [30], [34], [42], [45], [50], [52], [59], [64], [82] [3], [4], [22], [27], [40], [43], [54], [62], [71], [112] [20], [44], [72] [13], [30], [34], [45], [50], [64] [4], [27], [59], [62], [112] [22], [25], [43], [44], [71], [72] [20], [23], [30], [32], [45], [69], [112] [3], [4], [13], [30], [50], [68] |
...
| Others    | Language Understanding Language Modeling Fact Checking/Verification Text Generation Text Summarization Text Classification Sentiment Code Search Robustness Evaluation | MMLU [146] WikiText-103 [147] StrategyQA [148] FEVER [149] PubHealth [150] Biography [151] WikiASP [152] XSum [153] VioLens [154] TREC [155] SST-2 [156] CodeSearchNet [157] NoMIRACL [56] | [7], [27], [28], [42], [43], [47], [72] [5], [29], [64], [71] [14], [24], [48], [51], [55], [58] [4], [13], [27], [34], [42], [50] [25], [67] [67] [24] [17] [19] [33] [20], [33], [38] [76] [56]                                                                                                                   |
...
[8 https://www.trulens.org/trulens eval/core concepts rag triad/](https://www.trulens.org/trulens_eval/core_concepts_rag_triad/)

[9 https://kimi.moonshot.cn](https://kimi.moonshot.cn/)
...
[10 https://github.com/inverse-scaling/prize](https://github.com/inverse-scaling/prize)
...
[11 https://github.com/weaviate/Verba](https://github.com/weaviate/Verba)

[12 https://aws.amazon.com/cn/kendra/](https://aws.amazon.com/cn/kendra/)
...
- [4] P. Lewis, E. Perez, A. Piktus, F. Petroni, V. Karpukhin, N. Goyal, H. K¨ uttler, M. Lewis, W.-t. Yih, T. Rockt¨ aschel et al. , 'Retrievalaugmented generation for knowledge-intensive nlp tasks,' Advances in Neural Information Processing Systems , vol. 33, pp. 9459-9474, 2020.
...
- [122] T. Koˇ cisk` y, J. Schwarz, P. Blunsom, C. Dyer, K. M. Hermann, G. Melis, and E. Grefenstette, 'The narrativeqa reading comprehension challenge,' Transactions of the Association for Computational Linguistics , vol. 6, pp. 317-328, 2018.
...
- [166] [C. Jarvis and J. Allard, 'A survey of techniques for maximizing llm performance,' https://community.openai. com/t/openai-dev-day-2023-breakout-sessions/505213# a-survey-of-techniques-for-maximizing-llm-performance-2, 2023.](https://community.openai.com/t/openai-dev-day-2023-breakout-sessions/505213#a-survey-of-techniques-for-maximizing-llm-performance-2)
